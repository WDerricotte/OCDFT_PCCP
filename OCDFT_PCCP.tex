...
\\
All calculations pertaining to the NEXAS spectra of adenine and thymine were performed at the def2-TZVP/B3LYP level of theory. Peak intensities were approximated by taking the transition dipole moments ($\mu_i$) and calculating an oscillator strength ($f_{osc} $) for each transition ($\omega_{i}$)
  \begin{align}
  \label{osc}
