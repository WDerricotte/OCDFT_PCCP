...
\end{figure}
 ...
 $\phi_h$ &  $\phi_p$ & $\omega_{fi}$ & f$_{rel}$ & Peak &  $\omega_{fi}$   \\
   \hline
   80.6$\%$ $\pi_1^*$   & 399.14 & 0.862 \\
   63.7$\%$ $\pi_1^*$   & 399.28 & 0.934 \\
   91.2$\%$ $\pi_2^*$  & 399.42 & 1.000 \\
   81.4$\%$ $\pi_2^*$   & 399.55 & 0.836 \\
   90.8$\%$ $\pi_1^*$  & 399.67 & 0.011 \\
   52.6$\%$ $\pi_3^*$    & 399.79 & 0.840 \\
   89.3$\%$ $\pi_3^*$    & 400.37 & 0.998 \\
   89.2$\%$ $\pi_3^*$    & 400.38 & 0.986 \\
   83.2$\%$ $\pi_2^*$  & 400.50 & 0.135 \\
   81.0$\%$ $\pi_1^*$  & 401.45 & 0.375 \\
   68.2$\%$ $\pi_1^*$   & 401.81 & 0.609 \\
   72.4$\%$ $\pi_3^*$   & 401.97 & 0.172 \\
   76.7$\%$ $\rm D_2$   & 402.29 & 0.014 \\
   90.4$\%$ $\rm D_2$    & 402.42 & 0.012 \\
   90.3$\%$ $\rm D_2$    & 402.42 & 0.012 \\
   91.7$\%$ $\rm D_3$    & 402.46 & 0.033 \\
   78.0$\%$ $\rm D_2$   & 402.56 & 0.012 \\
   83.8$\%$ $\rm D_3$    & 402.73 & 0.038 \\
   69.6$\%$ $\rm D_3$    & 402.77 & 0.008 \\
   49.8$\%$ $\rm D_2$    & 402.92 & 0.326 \\
   44.1$\%$ $\pi_2^*$    & 402.94 & 0.264 \\
   47.6$\%$ $\rm D_4$   & 403.22 & 0.034 \\
   81.3$\%$ $\rm D_4$    & 403.23 & 0.018 \\
   80.5$\%$ $\rm D_4$    & 403.32 & 0.073 \\
   89.8$\%$ $\rm D_6$    & 403.34 & 0.021 \\
   74.0$\%$ $\rm D_4$    & 403.39 & 0.019 \\
   66.1$\%$ $\rm D_6$   & 403.54 & 0.877 \\
   74.3$\%$ $\rm D_5$    & 403.55 & 0.054 \\
   \end{tabular}
 \end{table}
  \begin{table}
 \centering
 ...
 $\phi_h$ &  $\phi_p$ & $\omega_{fi}$ & f$_{rel}$ & Peak &  $\omega_{fi}$   \\
   \hline
   92.6$\%$ $\pi_2^*$  & 286.32 & 0.298 \\
   81.0$\%$ $\pi^*_1$  & 286.46 & 0.936 \\
   92.4$\%$ $\pi^*_1$  & 286.71 & 0.260 \\
   82.1$\%$ $\pi^*_1$  & 286.86 & 0.893 \\
   69.3$\%$ $\pi^*_1$  & 287.27 & 1.000 \\
   63.7$\%$ $\pi^*_1$  & 287.41 & 0.961 \\
   81.6$\%$ $\pi_2^*$  & 287.86 & 0.000 \\
   34.7$\%$ $\pi^*_3$  & 287.93 & 0.092 \\
   98.9$\%$ $\pi_2^*$
 & 288.02 & 0.026 \\
   74.8$\%$ $\pi_2^*$  & 288.78 & 0.008 \\
   56.7$\%$ $\pi^*_3$  & 288.89 & 0.006 \\
   78.4$\%$ $\rm D_5$  & 288.91 & 0.001 \\
   36.4$\%$ $\rm D_5$  & 289.16 & 0.038 \\
   66.2$\%$ $\pi^*_3$  & 289.21 & 0.014 \\
   77.4$\%$ $\pi^*_3$  & 289.41 & 0.016 \\
   87.1$\%$ $\pi_2^*$  & 289.43 & 0.042 \\
   57.1$\%$ $\rm D_6$  & 289.66 & 0.329 \\
   39.1$\%$ $\rm D_5$  & 289.82 & 0.029 \\
   80.2$\%$ $\rm D_2$  & 289.98 & 0.266 \\
   90.2$\%$ $\rm D_2$  & 290.06 & 0.044 \\
   83.4$\%$ $\rm D_5$  & 290.14 & 0.166 \\
   87.2$\%$ $\rm D_2$  & 290.15 & 0.035 \\
   94.8$\%$ $\pi^*_3$  & 290.36 & 0.086 \\
   91.1$\%$ $\rm D_6$  & 290.37 & 0.020 \\
   61.6$\%$ $\rm D_7$  & 290.42 & 0.031 \\
   48.5$\%$ $\rm D_4$  & 290.45 & 0.014 \\
   69.0$\%$ $\rm D_5$  & 290.61 & 0.010 \\
   77.2$\%$ $\pi^*_3$  & 290.66 & 0.060 \\
