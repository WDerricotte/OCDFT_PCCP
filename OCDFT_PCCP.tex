...
%    \begin{tabular*}{8cm}{@{\extracolsep{\fill} }llcrrHH}
    \hline
    \hline
     Molecule & Excitation                     & Exp. (eV) & \multicolumn{2}{c}{Error (eV)} & $f_{abs} \times 10^{-2}$\\ ~&~ &~   & TDDFT  & OCDFT & OCDFT\\
     \hline
...
Previous computational studies of CO$_2$}\cite{maganas_combined_2014} \hl{showed that B3LYP/TD-DFT underestimates the oxygen K-edge by 14 eV.
...
%Since OCDFT reIn the case of molecules with a quasi-degenerate ground state, the OCDFT formalism does not offer 
