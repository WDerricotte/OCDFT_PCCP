...
Table \ref{table: assignment_comparison} shows a direct comparison of the assignments made in OCDFT, with those in ADC(2) by looking at the transitions of highest intensity at each K-edge. Our assignments match theirs exactly with only small deviation in the computed excitation energy (max error 0.54 eV), these small deviations are commensurate with OCDFT's MAE for first row elements (0.4 eV). The exact agreement between the classifications of these transitions is encouraging, and show that OCDFT can be a powerful tool to aid in near-edge spectroscopy.
\begin{table}
\caption{Comparison of the most intense transitions at each edge of the thymine and adenine spectra. OCDFT assignments and energies (in eV) are shown and are compared to the most intense transitions from the theoretical ADC(2) spectra shown in Ref ~\citenum{plekan_theoretical_2008}.}
\small
\centering
\begin{tabular}{ccc}
\hline
...
\hline 
\vspace{0.01cm}\\
\multicolumn{3}{c}{Thymine} \\
Oxygen Edge & O$_2$ $\rightarrow$ $\pi^*_1$ (531.05) &  O$_2$ $\rightarrow$ $\pi^*_1$ (531.36)  \\
Nitrogen Edge & N$_4$ $\rightarrow$ $\pi^*_1$ (401.18) & N$_4$ $\rightarrow$ $\pi^*_1$ (401.47) \\
Carbon Edge & C$_5$ $\rightarrow$ $\pi^*_2$ (289.14) & C$_5$ $\rightarrow$ $\pi^*_2$ (289.68) 
\vspace{0.7cm}\\
\multicolumn{3}{c}{Adenine} \\
Nitrogen Edge &  N$_5$ $\rightarrow$ $\pi^*_2$ (399.42) & N$_5$ $\rightarrow$ $\pi^*_2$ (399.64) \\
Carbon Edge & C$_6$ $\rightarrow$ $\pi^*_1$ (287.27) & C$_6$ $\rightarrow$ $\pi^*_1$ (287.37)\\
\hline
\hline
\end{tabular}
