...
\\[0.05in]
 ...
 \\[0.05in] 
    C$_9$
 &   80.2$\%$ $\rm D_1$  & 290.0 & 0.266 & \multirow{3}{*}{F} \\
    C$_8$
...
\hilight{Two classes of systems that are worth further exploration are transition metal complexes and open-shell molecules. Core excitations in transition metal complexes present a number of additional challenges that will require further extension of the present theory.
