...
Our benchmark computations on core excitations from 1s, 2s, and 2p orbitals of first- and second-row elements using conventional pure and hybrid functionals yield excitation energies with a mean absolute error (MAE) of 1.0 eV.
...
In addition, OCDFT assignments of the spectral features is in excellent agreement with that made using the ADC(2) method.\cite{plekan_theoretical_2008}
